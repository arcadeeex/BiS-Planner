...
local function CreatePickerFrame()
    ...
    elseif BisEquip_ApplyPanelBackdrop then BisEquip_ApplyPanelBackdrop(previewPanel)
        ...
        previewPanel:SetBackdropColor(0.12, 0.12, 0.13, 1)
        previewPanel:SetBackdropBorderColor(0.2, 0.2, 0.22, 1)
    end
...
local DISPLAY_NAMES = {
    ...
    -- GlobalStrings resistance keys in 3.3.5:
    -- RESISTANCE0_NAME is physical (armor), not fire.
...
-- Дательный падеж для "к X" (например: -100 к силе, +56 к мастерству)
